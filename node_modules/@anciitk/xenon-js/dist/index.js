      ...
      return Promise.resolve(new Promise(function (resolve, reject) {
        _this4._axios.post('/register', data, axios_config).then(function (resp) {
          ...
          switch ((_error$response2 = error.response) === null || _error$response2 === void 0 ? void 0 : _error$response2.status) {
            case 404:
              message = 'Either the username and roll number do not match or the username is invalid.\nOnly Y18,Y19, and Y20 UG students can currently register.';
              break;

            case 409:
              message = 'The username has already been registered. Please login directly or reset your password if you cannot remeber it. If you beleive this was a mistake please write to support@anciitk.in';
              break;

            default:
              message = 'An unknown error occured. Please try again later. If the issue persists please write to support@anciitk.in';
              break;
          }
