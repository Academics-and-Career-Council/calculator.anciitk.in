...
var normalize = css(function () { return cssNormalize; });

var globalStyles = function (_a) {
    var theme = _a.theme;
    return "\n" + normalize + "\n\nhtml, body {\n  background-color: " + theme.grey5 + ";\n}\n";
};
var GlobalStyle = createGlobalStyle(globalStyles);
...
var Button = function (_a) {
    ...
    return (React.createElement("div", { className: className },
        React.createElement("button", __assign({ className: "button" }, props)),
        helper && React.createElement("span", { className: "button-helper" }, helper)));
};
var Button$1 = styled(Button)(buttonStyles);
...
var LinkButton = function (_a) {
    var helper = _a.helper, className = _a.className, props = __rest(_a, ["helper", "className"]);
    return (React.createElement("div", { className: className },
        React.createElement("a", __assign({ onClick: function (e) {
                if (props.disabled) {
                    e.stopPropagation();
                    e.preventDefault();
                }
            }, "aria-disabled": props.disabled, className: cn('linkButton', { disabled: props.disabled }) }, props)),
        helper && React.createElement("span", { className: "linkButton-helper" }, helper)));
};
var LinkButton$1 = styled(LinkButton)(linkButtonStyles);

var Subtitle$1 = styled.div(typographyCaptionStyles);
var Checkbox = function (_a) {
    ...
    return (React.createElement("div", { className: className },
        title && React.createElement("div", { className: 'checkbox-title' }, title),
        React.createElement("div", { className: "checkbox-inner" },
            React.createElement("input", __assign({ id: id, type: "checkbox" }, props)),
            label && (React.createElement("label", { htmlFor: id },
                React.createElement("svg", { width: "8", height: "7", viewBox: "0 0 8 7", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
                    React.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M7.75 1.8125L2.75 6.8125L0.25 4.3125L1.1875 3.375L2.75 4.9375L6.8125 0.875L7.75 1.8125Z", fill: "#F9F9FA" })),
                React.createElement("span", null, label)))),
        subtitle && (React.createElement(Subtitle$1, { state: state, className: "checkbox-subtitle" }, subtitle))));
};
var Checkbox$1 = styled(Checkbox)(checkboxStyles);

var StyledH1 = styled.h1(typographyH1Styles);
var StyledH2 = styled.h2(typographyH2Styles);
var StyledH3 = styled.h3(typographyH3Styles);
var StyledLead = styled.span(typographyLeadStyles);
var StyledParagraph = styled.p(typographyParagraphStyles);
var StyledButtonTypography = styled.span(typographyButtonStyles);
var StyledCode = styled.code(typographyCodeStyles);
var StyledCaption = styled.span(typographyCaptionStyles);
var StyledAnchor = styled.a(typographyLinkStyles);
var H1 = function (props) { return React.createElement(StyledH1, __assign({}, props)); };
var H2 = function (props) { return React.createElement(StyledH2, __assign({}, props)); };
var H3 = function (props) { return React.createElement(StyledH3, __assign({}, props)); };
var Lead = function (props) { return React.createElement(StyledLead, __assign({}, props)); };
var P = function (props) { return React.createElement(StyledParagraph, __assign({}, props)); };
var B = function (props) { return React.createElement(StyledButtonTypography, __assign({}, props)); };
var Code = function (props) { return React.createElement(StyledCode, __assign({}, props)); };
var Caption = function (props) { return React.createElement(StyledCaption, __assign({}, props)); };
var Link$1 = function (props) { return React.createElement(StyledAnchor, __assign({}, props)); };

var CodeBox = function (_a) {
    _a.children; var code = _a.code, props = __rest(_a, ["children", "code"]);
    return (React.createElement("pre", __assign({}, props),
        React.createElement(Code, { dangerouslySetInnerHTML: { __html: code } })));
};
var CodeBox$1 = styled(CodeBox)(codeBoxStyles);

var Text = styled.div(forkMeStylesText);
styled.img(forkMeStylesImages);
styled.img(forkMeStylesFork);
var Link = styled.a(forkMeStylesLink);
var ForkMe = function (_a) {
    ...
    return (React.createElement("div", { className: className },
        React.createElement(Text, null,
            ...
            ' ',
            React.createElement(Link, { href: 'https://github.com/ory' }, "GitHub!"))));
};
var ForkMe$1 = styled(ForkMe)(forkMeStyles);

var Card = function (_a) {
    var className = _a.className; _a.wide; var props = __rest(_a, ["className", "wide"]);
    return (React.createElement("div", __assign({ className: className }, props)));
};
var Card$1 = styled(Card)(cardStyles);

var CardTitle = styled(H2)(cardTitleStyles);

var Field = styled.input(textInputStyles);
var Subtitle = styled.div(typographyCaptionStyles);
var Title = styled.div(typographyH3Styles);
var TextInput = function (_a) {
    ...
    return (React.createElement("div", { className: className },
        title && (React.createElement(Title, { state: state, className: className }, title)),
        React.createElement(Field, __assign({}, props, { state: state, type: type, className: className })),
        subtitle && (React.createElement(Subtitle, { state: state, className: className }, subtitle))));
};
...
var Alert$1 = styled(Alert)(alertStyles);

var AlertContent = styled(H3)(alertContentStyles);

export { Alert$1 as Alert, AlertContent, B, Button$1 as Button, Caption, Card$1 as Card, CardTitle, Checkbox$1 as Checkbox, Code, CodeBox$1 as CodeBox, ForkMe$1 as ForkMe, GlobalStyle, H1, H2, H3, Lead, Link$1 as Link, LinkButton$1 as LinkButton, P, TextInput, alertContentStyles, alertStyles, buttonStyles, cardStyles, cardTitleStyles, checkboxStyles, codeBoxStyles, cssButtonStyles, cssButtonStylesBig, cssCheckboxStyles, cssCodeBoxStyles, cssForkMeStyles, cssForkMeStylesFork, cssForkMeStylesImages, cssForkMeStylesLink, cssForkMeStylesText, cssLinkButtonStyles, cssLinkButtonStylesBig, cssMessageStyles, cssNormalize, cssTextInputStyles, cssTextInputSubtitleStyles, cssTextInputTitleStyles, cssTypographyButtonStyles, cssTypographyCaptionStyles, cssTypographyCodeStyles, cssTypographyH1Styles, cssTypographyH2Styles, cssTypographyH3Styles, cssTypographyLeadStyles, cssTypographyLinkStyles, cssTypographyParagraphStyles, forkMeStyles, forkMeStylesFork, forkMeStylesImages, forkMeStylesLink, forkMeStylesText, globalStyles, linkButtonStyles, messageStyles, textInputStyles, textInputSubtitleStyles, textInputTitleStyles, theme, typographyButtonStyles, typographyCaptionStyles, typographyCodeStyles, typographyH1Styles, typographyH2Styles, typographyH3Styles, typographyLeadStyles, typographyLinkStyles, typographyParagraphStyles, wrapCss };
